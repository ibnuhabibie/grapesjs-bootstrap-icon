...
<script src="https://unpkg.com/grapesjs-bootstrap-icon"></script>
...
const editor = grapesjs.init({
  ...
  plugins: ['grapesjs-bootstrap-icon'],
});
```
...
* Plugin name: `grapesjs-bootstrap-icon`
* Components
    * `component-id-1`
    * `component-id-2`
    * ...
...
<script type="text/javascript">
  var editor = grapesjs.init({
      ...
      plugins: ['grapesjs-bootstrap-icon'],
      pluginsOpts: {
        'grapesjs-bootstrap-icon': { /* options */ }
      }
  });
</script>
```
...
import plugin from 'grapesjs-bootstrap-icon';
